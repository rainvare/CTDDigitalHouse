...
public class TransferPage extends BasePage {
    ...
    protected static final String fromAccount = "//*[@id=\"fromAccountId\"]/option[1]"; // XPATH
    //error de select
    protected static final String toAccount = "//*[@id=\"fromAccountId\"]/option[2]"; // XPATH
    ...
    public void selectAccount() throws InterruptedException{
        WebElement first = getWebElement(By.xpath(fromAccount));
        first.click();
        Thread.sleep(2000);
    }

    public void selectAnotherAccount() throws InterruptedException{
        WebElement another = getWebElement(By.xpath(toAccount));
