...
--
-- Servidor: localhost
-- Tiempo de generación: 19-07-2021 a las 21:20:00
...
--
-- Estructura de tabla para la tabla `playlist_video`
--
...
--
-- Volcado de datos para la tabla `playlist_video`
--
...
--
-- Estructura de tabla para la tabla `tiporeaccion`
--
...
--
-- Volcado de datos para la tabla `tiporeaccion`
--
...
--
-- Estructura de tabla para la tabla `video_etiqueta`
--
...
--
-- Volcado de datos para la tabla `video_etiqueta`
--
...
--
-- Filtros para la tabla `playlist_video`
--
...
--
-- Filtros para la tabla `video_etiqueta`
--
