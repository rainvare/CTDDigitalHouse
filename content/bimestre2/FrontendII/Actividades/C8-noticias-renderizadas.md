...
function listarNoticias(data) {
    ...
    for (let i = 0; i < data.length; i++) {
        ...
        if (data[i].tipoNacional == true) {
            tipoNoticia = "text-danger"
        } else {
            tipoNoticia = "text-warning"
        }
        ...
        <div class="card-body">
            <h5 class="card-title ${tipoNoticia}">${data[i].titulo}</h5>
...
const noticias = [
    ...
    },
    {
        ...
        mgUrl:"https://www.infobae.com/new-resizer/mmsbZbq2RWQDDHGiP4MxaBbK6RQ=/768x432/filters:format(jpg):quality(85)/cloudfront-us-east-1.images.arcpublishing.com/infobae/TM2UEM7JNZE4JH2SXGPPGPTTOQ.jpg",
